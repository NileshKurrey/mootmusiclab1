...
function Maincontent() {
  const slider = [{title:'New Realease',CardsType:"Cards",id:1,style:{width: '90vw'}},{title:'New Albums',CardsType:"Cards",id:2,style:{width: '90vw'}},{title:'Explore Genres',CardsType:"CardGrid",id:3,style:{width: '90vw'}},
